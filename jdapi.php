...
if($_GET['id']) {
    ...
    $gdrivep = file_get_contents("https://player.nddrive.pw/apid/ff0a0bf0c5c4a3872b1e7d221d15a954?url=$google_link"); //ubah domain sesuai domain juicyplayer anda
	
	header("HTTP/1.1 301 Moved Permanently");
	header("Location: https://$gdrivep");
}